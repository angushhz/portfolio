...
export const timeLineData: TimeLineData[] = [
  {
    year: 2016,
    text: 'Started my journey to HCM city',
  },
  {
    year: 2019,
    text: 'Graduated high school and started my university life',
  },
  {
    year: 2020,
    text: 'Learned about software development',
  },
  {
    year: 2021,
    text: 'Shared my projects with the world and got a job as a Front-End Developer',
  },
  {
    year: 2022,
    text: 'Preparing for the future and focus on capstone project',
  },
]
