...
function Personal() {
    return (
        <section className="container">
            ...
            <p className="text-base text-[#ffffff]">Check out a few of my recent publishings.</p>
            ...
            <Link
                href="/blog"
                className="inline-flex items-center mt-12 hover:opacity-60 text-[#555a61] font-[650] text-[16px] py-[6px] px-[24px] bg-white rounded-3xl"
            >
                See all articles
            </Link>
        </section>
