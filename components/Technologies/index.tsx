    ...
    return (
        <section className="container">
            ...
            <p className="header-content md:header-content-larger">
                I've worked with a range a technologies in the web development world. From Back-end
                To Front-end.
            </p>
                ...
                {technologies.map((technology, id) => (
                    <li key={id} className="flex flex-row mb-[14px]">
                        ...
                        <div className="ml-[18px]">
                            <h3 className="text-xl font-bold mb-1 lg:text-3xl">
                                {parse(technology.skill)}
                            </h3>
